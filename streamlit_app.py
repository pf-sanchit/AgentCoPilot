...
with st.sidebar:
    ...
    st.markdown("- Which of AGT001's listings can be optimized for quality score?")
    st.markdown("- Which listings perform best on lead quality, not just count?")
    st.markdown("- Which listings did AGT001 spend the most credits on last week?")
    st.markdown("- What should AGT001's next target location be?")
