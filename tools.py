...
def run_python(code: str) -> str:
    ...
    Example:
        ...
        \"\"\"
    """
    # Load data via the same live-Gateway/CSV-fallback path the other tools
    # use, so the sandbox operates on identical data (source-agnostic — works
    # with live Gateway data or demo CSVs).
    _load()
    frames = {
