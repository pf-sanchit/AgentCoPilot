...
with st.sidebar:
    ...
    st.markdown("- Which agent has the most leads?")
    st.markdown("- How many credits did they spend?")
    st.markdown("- What is their conversion rate?")
    st.markdown("- Which community has the best ROI?")
